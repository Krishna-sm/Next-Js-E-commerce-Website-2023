    ...
    return (
        <div>
            <div className="rounded-r bg-gray-900 xl:hidden flex justify-between w-full p-6 items-center ">
                ...
                <div id="Main" className={`${show ? 'translate-x-0 z-[9]' : '-translate-x-full z-0'} xl:rounded-r transform  fixed md:relative  xl:translate-x-0  ease-in-out transition duration-500 flex justify-start items-start h-full  w-full sm:w-64 bg-gray-900 flex-col`}>
