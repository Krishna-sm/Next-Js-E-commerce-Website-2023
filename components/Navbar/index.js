    ...
    <>
      ...
      <header className="shadow py-4 ">
        <nav className="w-[95%] mx-auto flex items-center justify-between">
          ...
          >
            <span
              className={`block w-[36px] transition-all duration-300 ${
                isMobileNav
                  ? "rotate-45 translate-y-[9px]  border-b-white"
                  : "rotate-0 border-b-black"
              } h-2  border-b`}
            ></span>
            <span
              className={`block w-[36px] transition-all duration-300 ${
                isMobileNav ? "hidden  border-b-white" : "border-b-black"
              } h-2  border-b`}
            ></span>
            <span
              className={`block w-[36px] transition-all duration-300 ${
                isMobileNav
                  ? "-rotate-45  border-b-white"
                  : "rotate-0 border-b-black "
              } h-2 border-b`}
            ></span>
          </button>
          ...
          <form
            ...
            className="w-1/2 hidden  md:flex items-center px-3 boder ring-black ring-[.3px]"
          >
            <input
              value={search}
